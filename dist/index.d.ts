...
declare class SelasClient {
    ...
    runStableDiffusion(prompt: string, width?: 512 | 768, height?: 512 | 768, steps?: number, guidance_scale?: number, sampler?: "plms" | "ddim" | "k_lms" | "k_euler" | "k_euler_a", batch_size?: 1 | 2 | 3 | 4, image_format?: "avif" | "jpg" | "png" | "webp", translate?: boolean, diffusion_model?: string, worker_config?: WorkerConfig, token_key?: string): Promise<{
        error: string;
        data?: undefined;
        message?: undefined;
    } | {
